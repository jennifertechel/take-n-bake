...
class LooserScene extends MessageBox {
    ...
    constructor(game: IScene) {
        ...
        this.game = game;
        this.buttonRestart = new Button(createVector(innerWidth/2-225, 530), "Restart", "levelScene");
        this.buttonQuit = new Button(createVector(innerWidth/2+25, 530), "Quit game", "startScene");
