...
class MenuScene {
  ...
  constructor(game: IScene) {
    ...
    this.buttonStartGame = new Button (createVector(innerWidth/2-225, 650), "Start", "recipeScene");
    this.buttonQuitGame = new Button (createVector(innerWidth/2+25, 650), "Quit", "startScene");
  ...
  public draw() {
    ...
    textSize(40);
    text(this.gameRulesHeading, innerWidth/2-485, innerHeight/2-240, 970, 230);
    textSize(30);
    textAlign(CENTER);
